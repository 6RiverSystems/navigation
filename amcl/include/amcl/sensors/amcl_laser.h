...
class AMCLLaser : public AMCLSensor
{
  ...
  public: static double calculateBeamWeight(double z, AMCLLaser *self, double range_max = 25.0);
  public: static double calculateClosestObstacle(pf_vector_t& pose, AMCLLaser *self);
